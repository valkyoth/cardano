#!/usr/bin/env python3
"""Publish cardano workspace crates in crates.io dependency order."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Publish cardano workspace crates in crates.io order."
    )
    parser.add_argument(
        "--version",
        default=None,
    ...
    print(f"Recommended follow-up: cargo info cardano@{args.version}")
    return 0
