<p align="center">
  <b>optional Cardano node protocol boundaries for cardano.</b><br>
...
<div align="center">
  ...
  |
  <a href="https://docs.rs/cardano-valkyoth-node">Docs.rs</a>
  |
...
Support crate for `cardano`: future node protocol boundaries.
...
Planned scope includes optional node-to-client and node-to-node protocol types,
chain-sync state machines, and explicit trust/resource policy.
