<p align="center">
  <b>era-aware Cardano ledger boundary planning for cardano.</b><br>
...
<div align="center">
  ...
  |
  <a href="https://docs.rs/cardano-valkyoth-ledger">Docs.rs</a>
  |
...
Support crate for `cardano`: future era-aware Cardano ledger boundaries.
...
Planned scope includes Byron, Shelley, Allegra, Mary, Alonzo, Babbage, and
Conway transaction, block, certificate, UTxO, and validation-state surfaces.
